                ...
                <CardContent className="pt-2">
                    <div className="space-y-4">
                        <div>
                            ...
                            <Input type="text" id="vehicleId" value={props.vehicleId}
                        ...
                        <div>
                            ...
                            <Input type="text" id="licensePlateNumber" value={props.licensePlateNumber}
                        ...
                        <div>
                            ...
                            <Input type="text" id="vehicleCategory" value={props.vehicleCategory}
                                   onChange={(e) => props.setVehicleCategory(e.target.value)} required/>
                        </div>
                        <div>
